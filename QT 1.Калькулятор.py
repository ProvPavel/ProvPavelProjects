...
class Window(QWidget):
    def __init__(self, TEXT_COLOR=None, BACKGROUND_COLOR=None, BORDER_SIZE=None, BORDER_COLOR=None):
        ...
        self.button_7.setStyleSheet('background-color: rgb(0,255,0); '
                                    f'font-size: 10px; '
                                    f'border: 1px solid rgb(255,255,255)')
        ...
        self.button_8.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_9.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.res_1.setText('+')
        self.res_1.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_4.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_5.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_6.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.res_2.setText('-')
        self.res_2.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_1.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_2.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_3.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.res_3.setText('*')
        self.res_3.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_C.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_0.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.button_point.setStyleSheet('background-color: rgb(0,255,0)')
        ...
        self.res_4.setText('/')
        self.res_4.setStyleSheet('background-color: rgb(0,255,0)')
